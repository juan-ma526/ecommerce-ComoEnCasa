      ...
      <div className="flex justify-between items-center pt-6 pb-6">
        ...
        {toggle && (
          <motion.div
            initial={{ x: -500 }}
            animate={{ x: 0 }}
            className="fixed left-0 top-36 bg-white h-screen text-black w-80"
          >
            <nav className="mt-0">
        ...
        <div className="flex justify-center items-center md:hidden">
          <BiSearch size="24px" style={{ margin: "9px" }} />
          <BiUser size="24px" style={{ margin: "9px" }} />
          <BiCart size="24px" style={{ margin: "9px" }} />
        </div>
      </div>
      <div className=" justify-between items-center pt-6 pb-6 hidden md:flex">
        ...
        <nav className="mt-0">
          <ul className=" hidden md:inline-flex">
            <li className="text-lg py-4 px-3 text-amber-800">Home</li>
            <li className="text-lg py-4 px-3">Shop</li>
            <li className="text-lg py-4 px-3">Features</li>
            <li className="text-lg py-4 px-3">Blog</li>
            <li className="text-lg py-4 px-3">About Us</li>
            <li className="text-lg py-4 px-3">Contact Us</li>
          </ul>
        </nav>
